...
public class addRule extends JFrame // implements MouseListener
{
...
//	public LogicServer ls;
	...
	void addKnow() {
		...
		try {
			...
			// Tải ODBC (tùy chọn, bạn có thể lấy phần này ra nếu không sử dụng)
			// Ngoài ra, bạn có thể gọi ls.InitLSX () sẽ tải bất kỳ
			// LSX nào được chỉ định trong amzi.cfg
			ls.AddLSX("aodbc", 0);
			System.out.print("3");
			// Load the Jig
			ls.Load("basic.xpl");
			System.out.print("4");
			// Khởi tạo thời gian chạy với thư mục và logfile
			// Trước khi bắt đầu một phiên KWI mới, id phiên phải làkw_init.
