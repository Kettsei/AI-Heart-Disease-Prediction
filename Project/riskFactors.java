...
public class riskFactors extends JFrame {
	...
	public JTextField ageOutput, genderOutput, historyOutput, smokeOutput, obesOutput, diabOutput, hyperOutput,
			cholOutput, stressOutput, workOutput;
