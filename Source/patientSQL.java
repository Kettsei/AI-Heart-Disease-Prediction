...
public class patientSQL {
	...
	public void add() {
		try {
			...
			String query = "INSERT INTO patient (patient_id, name, sex, age, contact, history" + ") VALUES ('" + id
					+ "','" + name + "','" + sex + "','" + age + "','" + contact + "','" + history + "')";
	...
	public void update() {
		try {
			Statement statement = con.createStatement();
			String query1 = "UPDATE patient SET " + "name ='" + name + "', sex ='" + sex + "', age ='" + age
					+ "', contact ='" + contact + "', history ='" + history + "' WHERE patient_id LIKE '%" + id + "%'";
	...
	public void delete() {
		try {
			...
			int rs = JOptionPane.showConfirmDialog(null,
					"WARNING!! Record once deleted cannot be retrieved!! Continue with delete?", "CONFIRM",
					JOptionPane.YES_NO_OPTION);
			if (rs == JOptionPane.YES_OPTION) {
				String query3 = "delete * from patient " + "where patient_id = '" + id + "'";
