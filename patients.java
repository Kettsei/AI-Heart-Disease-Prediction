		...
		id_text.addFocusListener(new FocusListener() {
			public void focusLost(FocusEvent e) {
				try {
					...
					String query = "SELECT * FROM patient " + "WHERE patient_id = '" + id_text.getText() + "'";
	...
	protected void addButtons(JToolBar toolBar) {
		...
		button2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				patientSQL psql = new patientSQL(id_text.getText(), name_text.getText(), sexy, agy,
						contact_text.getText(), history_text.getText());
				psql.add();
				id_text.setText("P-");
				name_text.setText("");
				contact_text.setText("");
